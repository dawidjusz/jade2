	...
	private class RequestPerformer extends Behaviour {
	  ...
	  public void action() {
		...
		if(budget < bestPrice) { //sprawdzamy czy kupujacy ma wystarczajacy budzet
			System.out.println(getAID().getLocalName() + ": Nie masz tyle, potrzebujesz " + bestPrice + ", obecnie masz: " + budget); // wyswietlamy info przy braku
	    ...
	    case 3:      
		  ...
		  System.out.println(getAID().getLocalName() + ": Zostalo " + budget + " w portfelu"); // Wyświetlamy ile pozostało w budżecie po prawidłowym zakupie
		  targetBookTitle = "";
	          //myAgent.doDelete();
	        }
	        else {
